...
class CUSTOMER : public Canteen
 {
protected:
    string customer_id="19399";
    string customer_name="jesey";
    string customer_email="customer@gmail.com";
...
protected:
    ...
    string teacher_id="23456";
    string teacher_email="teacher@gmail.com";
...
protected:
    string Student_name="Arnab";
    string Student_id="6789";
    string Student_email="student@gmail.com";
    string Student_password="4567";
public:
...
int main()
{
    ...
    cin>> cus_type;
    string name,id,pass,email;
   cout<<"Enter Your Customer Name:"<<endl;
   cin>> name;
    cout<<"Enter Your Customer Id:"<<endl;
   cin>> id;
    cout<<"Enter Your Customer Password:"<<endl;
   cin>> pass;
   if(id==C1.getCustomerId() && pass== C1.getCustomerPassword()){
